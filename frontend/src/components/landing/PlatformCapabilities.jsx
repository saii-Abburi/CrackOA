...
import {
  ...
  CheckCircle2, FileText, BookOpen, PenLine,
} from 'lucide-react';
import { platformFeatures } from '../../data/landingData.js';

const iconMap = { Building2, TrendingUp, SlidersHorizontal, CheckCircle2, FileText, BookOpen, PenLine };
    ...
    <section className="py-24" aria-labelledby="capabilities-heading">
      <div className="container-xl">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="section-badge mb-5">Platform</span>
          <h2 id="capabilities-heading" className="section-heading mb-5">
